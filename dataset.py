...
class CustomDataset(Dataset):
    def __init__(self, data_dir):
        ...
        # For training
        self.images_dir = os.path.join(data_dir, 'train256')
        self.features_dir = os.path.join(data_dir, 'train-vae')
        # # # For validation
        # self.images_dir = os.path.join(data_dir, 'val256')
        # self.features_dir = os.path.join(data_dir, 'val-vae')
        # images
        self._image_fnames = {
        ...
        # labels
        fname = '/mnt/ssd/dataset/image/imagenet-1k/data/train256/dataset.json'
