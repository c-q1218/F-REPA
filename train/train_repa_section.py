...
from models.sit import REPA
from loss.REPA_loss import REPALoss
    ...
    for epoch in range(args.epochs):
        ...
        for raw_image, x, y in train_dataloader:
            ...
            with accelerator.accumulate(model):
                ...
                proj_loss = loss_fn(model, x, model_kwargs, zs=zs)
...
def parse_args(input_args=None):
    ...
    parser.add_argument("--max-train-steps", type=int, default=4000000)
