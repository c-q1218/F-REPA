...
if __name__ == "__main__":
    ...
    # model SiT_models
    parser.add_argument("--model", type=str, choices=list(FA_models.keys()), default="SiT-XL/2")
    ...
    parser.add_argument("--sample-folder-dir",type=str,default="/REPA/generated-result/")
